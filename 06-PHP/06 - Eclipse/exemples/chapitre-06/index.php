...
if ($afficher_source) {
  ...
  $liens['20-download-formulaire.php'] = 'Télécharger un fichier à partir du serveur (download) - Formulaire';
  $liens['21-download-lien.php'] = 'Télécharger un fichier à partir du serveur (download) - Liens';
