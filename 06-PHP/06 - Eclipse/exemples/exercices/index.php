...
if ($afficher_source) {
  ...
  $liens['<14>'] = 'Exercice 14 : gérer les sessions';
  $liens['14/accueil.php'] = 'accueil.php';
  $liens['14/auteur.php'] = 'auteur.php';
  $liens['14/commun.inc.php'] = 'commun.inc.php';
  $liens['<15>'] = 'Exercice 15 : envoyer un courrier électronique';
  $liens['15/mail.php'] = 'mail.php';
}
