...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr">
  ...
  <body>
    ...
    <?php
    // Utiliser des erreurs de niveau E_WARNING (pas des exceptions).
    // Ces erreurs seront masquées du fait de l'utilisation de l'opérateur @.
    ...
    function connecter($hôte=NULL,$utilisateur=NULL,$mot_de_passe=NULL) {
      ...
      if ($connexion) {
        ...
        echo 'Jeu de caractères utilisé par la connexion : ', 
             mysqli_character_set_name($connexion),'<br />'; 
      } else {
        printf(
          'Erreur %d : %s.<br />',
