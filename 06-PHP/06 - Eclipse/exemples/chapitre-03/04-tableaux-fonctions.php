...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr">
  ...
  <body>
    ...
    foreach($tableau_bis as $clé => $valeur)
      { echo "$clé => $valeur<br />"; }
    // asort
    echo '<b>asort : tri sur valeur, couples clé/valeur préservés</b><br />';
    $tableau_bis = $tableau;
    asort($tableau_bis);
    foreach($tableau_bis as $clé => $valeur)
      { echo "$clé => $valeur<br />"; }
    // ksort
    echo '<b>ksort : tri sur clé, couples clé/valeur préservés</b><br />';
    $tableau_bis = $tableau;
    ksort($tableau_bis);
    foreach($tableau_bis as $clé => $valeur)
      { echo "$clé => $valeur<br />"; }
    ...
    <h1>array_key_first() - array_key_last()</h1>
    <?php
    $tableau = ['C' => 1, 'B' => 2, 'A' => 3, 0 => 'zéro']; 
    echo 'array_key_first = ',array_key_first($tableau),'<br />'; 
    echo 'array_key_last  = ',array_key_last($tableau),'<br />'; 
    ?>
