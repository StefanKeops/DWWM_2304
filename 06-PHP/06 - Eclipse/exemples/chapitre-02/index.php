...
if ($afficher_source) {
  ...
  $liens['5.1-4/07-decomposer-tableau.php'] = 'Décomposer un tableau';
  ...
  $liens['5.5/04-operateur-affectation-union-null.php'] = 'L\'opérateur d\'affectation d\'union NULL';
  $liens['5.5/05-operateur-comparaison-combinee.php'] = 'L\'opérateur de comparaison combinée';
